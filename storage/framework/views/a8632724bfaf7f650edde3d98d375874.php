                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $properties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="border-b border-gray-600 hover:bg-gray-600">
                            <td class="py-3 px-4">
                                <img src="<?php echo e(asset('storage/' . $property->main_image)); ?>" alt="Property Image" class="h-16 w-24 object-cover rounded-md">
                            </td>
                            <td class="py-3 px-4"><?php echo e($property->location); ?></td>
                            <td class="py-3 px-4"><?php echo e(number_format($property->monthly_rent)); ?></td>
                            <td class="py-3 px-4">
                                <?php if($property->is_occupied): ?>
                            ...
                            <td class="py-3 px-4">
                                <form action="<?php echo e(route('properties.destroy', $property)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this property?');">
                                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\laravel-rental-system-main\resources\views/properties/index.blade.php ENDPATH**/ ?>