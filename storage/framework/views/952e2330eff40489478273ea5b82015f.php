...
<head>
    ...
    <title><?php echo e(config('app.name', 'Laravel')); ?> - Property Listings</title>
...
<body class="font-sans antialiased bg-gray-100">
    ...
    <div class="relative px-4">
        <!-- Search Bar (Static at the moment) -->
    ...
    <main class="max-w-7xl mx-auto py-12 px-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $properties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="bg-white rounded-lg shadow-md overflow-hidden group">
                    <div class="relative">
                        ...
                        <img src="<?php echo e(asset('storage/' . $property->image_url)); ?>" alt="<?php echo e($property->property_type); ?> in <?php echo e($property->location); ?>" class="w-full h-56 object-cover">
                    </div>
                    <div class="p-5">
                        <p class="font-bold text-xl text-gray-800">Rs. <?php echo e(number_format($property->monthly_rent)); ?>/month</p>
                        <h3 class="font-semibold text-lg mt-2 text-gray-900"><?php echo e($property->property_type); ?> for Rent in <?php echo e($property->location); ?></h3>
                        <p class="text-gray-600 text-sm mt-1"><?php echo e($property->address); ?></p>
                        ...
                        <div class="flex items-center justify-start space-x-6 mt-4 pt-4 border-t border-gray-200">
                            <div class="flex items-center space-x-2 text-gray-700">
                                ...
                                <span><?php echo e($property->number_of_rooms); ?></span>
                            </div>
                             <div class="flex items-center space-x-2 text-gray-700">
                            ...
                            <div class="flex items-center space-x-2 text-gray-700">
                                ...
                                <span><?php echo e($property->furnish_status); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <p class="col-span-full text-center text-gray-500 text-lg py-16">No properties found at the moment.</p>
            <?php endif; ?>
        </div>
    </main>
...
<?php /**PATH C:\xampp\htdocs\laravel-rental-system-main\resources\views/properties/public-index.blade.php ENDPATH**/ ?>